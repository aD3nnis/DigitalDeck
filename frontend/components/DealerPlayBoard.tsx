...
const SLOTS: SlotPaths[] = [
  ...
  },
  {
    ...
    stroke:
      "M144.56,2.87v1s27.23.07,27.23.07c.51,0,.95.25,1.03.36l13.2,28.36c-.05,0-.12.02-.2.02h-32.25c-.63,0-1.14-.37-1.19-.57l-7.99-28.22s.11-.01.18-.01v-1M144.56,2.87c-.83,0-1.38.41-1.24.93l8.09,28.57c.2.71,1.17,1.3,2.15,1.3h32.25c.98,0,1.51-.58,1.18-1.29l-13.27-28.51c-.24-.51-1.11-.93-1.93-.93l-27.23-.07h0Z",
  },
];
